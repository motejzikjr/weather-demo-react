...
export const CurrentWeatherCard = ({ current, onRefresh }: CurrentWeatherCardProps) => {
  return (
    <div className="CurrentWeatherCard flex flex-col gap-4 p-4 border-2 border-amber-600 rounded-lg w-full sm:w-max">
